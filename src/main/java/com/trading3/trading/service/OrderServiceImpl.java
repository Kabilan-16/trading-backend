...
import com.trading3.trading.domain.OrderStatus;
import com.trading3.trading.domain.OrderType;
import com.trading3.trading.modal.*;
import com.trading3.trading.repository.OrderItemRepository;
import com.trading3.trading.repository.OrderRepository;
...
public class OrderServiceImpl implements OrderService{
    ...
    public Order createOrder(User user, OrderItem orderItem, OrderType orderType) {
        double price=orderItem.getCoin().getCurrentPrice()*orderItem
                .getQuantity();
